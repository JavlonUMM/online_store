...
class Brand(models.Model):
    ...
    logo = models.ImageField(upload_to='media/brand/', null=True, blank=True)
    description = models.TextField(max_length=255, null=True, blank=True)
...
class Product(models.Model):
    ...
    actual_price = models.DecimalField(verbose_name="Original narx", max_digits=13, decimal_places=2, null=True,
                                       blank=True)
